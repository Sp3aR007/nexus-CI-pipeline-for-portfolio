...
def pushImage(){
    echo 'Building Image ...'
    sh "docker build -t 13.127.115.242:8082/sanskriti-portfolio:${BUILD_NUMBER} ."

    echo 'Pushing image to docker hosted rerpository on Nexus'

    withCredentials([usernamePassword(credentialsId: 'nexus', passwordVariable: 'PSW', usernameVariable: 'USER')]){
        sh "echo ${PSW} | docker login -u ${USER} --password-stdin 13.127.115.242:8082"
        sh "docker push 13.127.115.242:8082/sanskriti-portfolio:${BUILD_NUMBER}"
    }
}
...
def commitChanges(){
        ...
        sh "git remote set-url origin https://${USER}:${PSW}@https://github.com/Sp3aR007/nexus-CI-pipeline-for-portfolio.git"
